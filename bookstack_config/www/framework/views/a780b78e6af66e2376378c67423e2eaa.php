    ...
    <div class="form-group">
            ...
            <div class="dropdown-container ml-auto" component="dropdown">
                ...
                <div refs="dropdown@menu shelf-sort@sort-button-container" class="dropdown-menu" role="menu">
                    <button type="button" class="text-item"
                            data-sort="name"><?php echo e(trans('entities.books_sort_name')); ?></button>
                    <button type="button" class="text-item"
                            data-sort="created"><?php echo e(trans('entities.books_sort_created')); ?></button>
                    <button type="button" class="text-item"
                            data-sort="updated"><?php echo e(trans('entities.books_sort_updated')); ?></button>
                </div>
            </div>
        </div>
        <ul refs="shelf-sort@shelf-book-list"
            ...
            <?php $__currentLoopData = ($shelf->visibleBooks ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo $__themeViews->handleViewInclude('shelves.parts.shelf-sort-book-item', ['book' => $book], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
...
<div class="form-group collapsible" component="collapsible" id="tags-control">
    ...
    <div refs="collapsible@content" class="collapse-content">
        <?php echo $__themeViews->handleViewInclude('entities.tag-manager', ['entity' => $shelf ?? null], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
    </div>
</div>

<div class="form-group text-right">
    <a href="<?php echo e(isset($shelf) ? $shelf->getUrl() : url('/shelves')); ?>"
...
<?php echo $__themeViews->handleViewInclude('form.editor-translations', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?><?php /**PATH /app/www/resources/views/shelves/parts/form.blade.php ENDPATH**/ ?>