        ...
        <main class="card content-wrap mt-xxl">
            ...
            <div class="flex-container-row wrap justify-space-between items-center mb-s gap-m">
                <div class="block inline mr-xs">
                    <form method="get" action="<?php echo e(url("/tags")); ?>">
                        <?php echo $__themeViews->handleViewInclude('form.request-query-inputs', ['params' => ['name']], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
                        <input type="text"
                               name="search"
            ...
            <?php if($nameFilter): ?>
                <div class="my-m">
                    ...
                    <?php echo $__themeViews->handleViewInclude('entities.tag', ['tag' => new \BookStack\Activity\Models\Tag(['name' => $nameFilter])], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
                    <form method="get" action="<?php echo e(url("/tags")); ?>" class="inline block">
                        <?php echo $__themeViews->handleViewInclude('form.request-query-inputs', ['params' => ['search']], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
            ...
            <?php if(count($tags) > 0): ?>
                <div class="item-list mt-m">
                    <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo $__themeViews->handleViewInclude('tags.parts.tags-list-item', ['tag' => $tag, 'nameFilter' => $nameFilter], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
