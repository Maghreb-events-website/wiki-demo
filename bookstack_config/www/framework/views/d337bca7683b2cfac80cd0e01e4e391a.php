        ...
        <div class="grid left-focus gap-xl">
            <div>
                <div component="book-sort" class="card content-wrap auto-height">
                    ...
                    <div refs="book-sort@sortContainer">
                        <?php echo $__themeViews->handleViewInclude('books.parts.sort-box', ['book' => $book, 'bookChildren' => $bookChildren], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
                    </div>
            ...
            <div>
                <main class="card content-wrap auto-height sticky-top-m">
                    ...
                    <?php echo $__themeViews->handleViewInclude('entities.selector', ['name' => 'books_list', 'selectorSize' => 'compact', 'entityTypes' => 'book', 'entityPermission' => 'update'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
