<div component="code-highlighter" class="card content-wrap auto-height">
    <h2 class="list-heading"><?php echo e(trans('settings.webhooks_format_example')); ?></h2>
    <p><?php echo e(trans('settings.webhooks_format_example_desc')); ?></p>
...
</div><?php /**PATH /app/www/resources/views/settings/webhooks/parts/format-example.blade.php ENDPATH**/ ?>